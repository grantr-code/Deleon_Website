    ...
    <div :class="subpage ? 'max-w-none mx-auto px-4 sm:px-6 lg:px-10 xl:px-16 2xl:px-24' : 'max-w-[1280px] mx-auto px-4'">
      ...
      <div v-if="subpage">
        <div class="flex items-center justify-between gap-4">
          <a href="/" class="flex items-center gap-3.5" aria-label="Deleon">
            ...
            <span ref="brandText" class="font-logo font-semibold uppercase tracking-[0.15em] text-[1.10rem] md:text-[1.25rem] relative top-[3px]">{{ data.brandText }}</span>
          </a>
      ...
      <div v-else>
        <div class="flex items-center justify-between gap-4">
          <a href="/" class="flex items-center gap-3.5" aria-label="Deleon">
            <img :src="data.logoSrc" alt="Deleon logo" class="h-10 md:h-11 w-auto" />
            <span class="font-logo font-semibold uppercase tracking-[0.15em] text-[1.10rem] md:text-[1.25rem] relative top-[3px]">{{ data.brandText }}</span>
          </a>
          <div class="flex items-center gap-3">
            <!-- Desktop chips (right aligned); auto-collapse to hamburger on overflow -->
            <ul
